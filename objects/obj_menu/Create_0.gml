...
audio_group_set_gain(audiogroup_default,0.25,0);
...
// Retrieve keyword descriptors
var file_id = file_text_open_read("keyword_descriptors.json");
var json_string = "";
...
global.keyword_descriptors = json_parse(json_string);
