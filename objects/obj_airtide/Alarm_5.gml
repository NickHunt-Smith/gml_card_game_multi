if opp = true {
	if global.player_locale_1 = noone && global.player_locale_2 = noone && global.player_locale_3 = noone && global.player_locale_4 = noone {
		...
		if sucked_in = true {
			...
			if global.plaxer_locale_1 != noone {
				global.plaxer_locale_1.y = lerp(global.plaxer_locale_1.y,844,lerp_amount);
				global.plaxer_locale_1.x = lerp(global.plaxer_locale_1.x,1283,lerp_amount);
			}
			if global.plaxer_locale_2 != noone {
				global.plaxer_locale_2.y = lerp(global.plaxer_locale_2.y,844,lerp_amount);
				global.plaxer_locale_2.x = lerp(global.plaxer_locale_2.x,1545,lerp_amount);
			}
			if global.plaxer_locale_3 != noone {
				global.plaxer_locale_3.y = lerp(global.plaxer_locale_3.y,844,lerp_amount);
				global.plaxer_locale_3.x = lerp(global.plaxer_locale_3.x,1805,lerp_amount);
			}
			if global.plaxer_locale_4 != noone {
				global.plaxer_locale_4.y = lerp(global.plaxer_locale_4.y,844,lerp_amount);
				global.plaxer_locale_4.x = lerp(global.plaxer_locale_4.x,1018,lerp_amount);
			}
			alarm[5] = 1;
		}
	}
