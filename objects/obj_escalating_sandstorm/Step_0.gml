...
if eff_type = "lingering" {
	...
	if first_linger = true {
		...
		card_state.tooltip_text = "Turn";
		card_state.tooltip_text_plural = true;
		play_turn_count = global.turn_count;
		current_turn_count = global.turn_count;
		first_linger = false;
	}
	
	if current_turn_count != global.turn_count {
		current_turn_count = global.turn_count;
	}
	
	card_state.tooltip_counter = current_turn_count - play_turn_count;
