...
if (eff_type = "play") && (wait = true) && (wait_target = false) {
	...
	eff_instructions_1 = "Deal " + string(abs(total_damage_1)) + " to friendly locale";
	var total_damage_2 = 0;
	if opp = true {
		total_damage_2 = play_damage_2 + global.opponent.ruby_bonus_spell_damage;
	} else {
		total_damage_2 = play_damage_2 + global.player.ruby_bonus_spell_damage;
	}
	eff_instructions_2 = "Deal " + string(abs(total_damage_2)) + " to different locale";
