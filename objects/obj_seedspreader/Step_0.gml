...
if eff_type = "lingering" {
	...
	if (opp = true && global.opp_playing_locale = true) or (opp = false && global.player_playing_locale = true) {
		if channel_up_seq = noone && card_state.play_seq = noone {
			channel_up_seq = layer_sequence_create("effect_layer",card_state.x+112,card_state.y+184,seq_channel_up);
			var seq_change_health = scr_change_numbers(strength_boost,card_state.x+global.health_offset_x,card_state.y + 328);
