...
//Pass
if global.tutorial_step = 96 {
	global.resolve_stack = true;
	deciding = false;
}

// Play clearing
if global.tutorial_step = 97 {
	hand_choice = 0;
	array_delete(hand_rarity,hand_choice,1);
	array_delete(hand_card_type,hand_choice,1);
