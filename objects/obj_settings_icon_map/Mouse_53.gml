...
if mouse_x > c_x + 0.95*view_wport[1] - 0.5*resize_scale*sprite_width && mouse_x < c_x + 0.95*view_wport[1] + 0.5*resize_scale*sprite_width && mouse_y > c_y + 0.08*view_hport[1] - 0.5*resize_scale*sprite_height && mouse_y < c_y + 0.08*view_hport[1] + 0.5*resize_scale*sprite_height {
