if mouse_x > x_surface && mouse_x < x_surface + portal_x*2 && mouse_y > y_surface && mouse_y < y_surface + portal_y*2{

	if portal_done_1 = true {
		var ruby_click = layer_sequence_create("background_stars",mouse_x,mouse_y,seq_rock_click);
		array_push(ruby_clicks,ruby_click);
	}

	if portal_done_2 = true {
		var pearl_click = layer_sequence_create("background_stars",mouse_x,mouse_y,seq_ice_click);
		array_push(pearl_clicks,pearl_click);
	}
	...
	if portal_done_4 = true {
		var sapphire_click = layer_sequence_create("background_stars",mouse_x,mouse_y,seq_click_sapphire);
		array_push(sapphire_clicks,sapphire_click);
	}
	
	if portal_done_5 = true {
		var emerald_click = layer_sequence_create("background_stars",mouse_x,mouse_y,seq_click_emerald);
		array_push(emerald_clicks,emerald_click);
	}
	
	if portal_done_6 = true {
		var citrine_click = layer_sequence_create("background_stars",mouse_x,mouse_y,seq_click_citrine);
		array_push(citrine_clicks,citrine_click);
	}
	
	if portal_done_7 = true {
		var opal_click = layer_sequence_create("background_stars",mouse_x,mouse_y,seq_click_opal);
		array_push(opal_clicks,opal_click);
	}
	
	if portal_done_8 = true {
		var amethyst_click = layer_sequence_create("background_stars",mouse_x,mouse_y,seq_click_amethyst);
		array_push(amethyst_clicks,amethyst_click);
	}
}
