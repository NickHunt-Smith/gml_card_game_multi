...
if global.end_turn_active = true && array_length(global.being_destroyed) = 0 && global.end_game_trigger = false && global.drafting = false && global.lingering_active = false {
