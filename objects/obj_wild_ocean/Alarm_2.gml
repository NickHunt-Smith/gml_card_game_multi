...
card_state.effect_function = obj_tempestuous_ocean;
...
var lingering_effect_inst_opp = instance_create_depth(card_state.x,card_state.y,-800,obj_tempestuous_ocean);
