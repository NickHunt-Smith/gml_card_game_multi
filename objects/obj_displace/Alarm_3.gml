...
target_1.opp = true;
if instance_exists(target_1.effect_function_inst) {
	target_1.effect_function_inst.opp = true;
}
if instance_exists(target_1.lingering_effect_function_inst) {
	target_1.lingering_effect_function_inst.opp = true;
}

target_2.opp = false;
if instance_exists(target_2.effect_function_inst) {
	target_2.effect_function_inst.opp = false;
}
if instance_exists(target_2.lingering_effect_function_inst) {
	target_2.lingering_effect_function_inst.opp = false;
}
