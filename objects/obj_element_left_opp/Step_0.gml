...
if array_max(global.channelled_right_opp) >= 20 && array_max(global.channelled_left_opp) >= 20 && global.end_game_trigger = false {
...
if array_max(global.channelled_left_opp) >= 20 && power_swirling = noone {
