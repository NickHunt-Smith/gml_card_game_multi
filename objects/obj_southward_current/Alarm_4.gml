...
if target_1 = noone {
	if opp = true {
		var effect_arr = scr_play_locale(opp,"left_opp",0,3,1,noone,noone,noone,false,true);
	} else {
		var effect_arr = scr_play_locale(opp,"left_player",0,3,1,noone,noone,noone,false,true);
	}
	alarm[3] = 40;
