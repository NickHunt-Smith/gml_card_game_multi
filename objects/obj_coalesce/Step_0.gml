...
if (eff_type = "play") && (wait = true) && (wait_target = false) {
	...
	if opp = true {
		total_damage_1 = -card_state.order_in_stack + global.opponent.ruby_bonus_spell_damage;
	} else {
		total_damage_1 = -card_state.order_in_stack + global.player.ruby_bonus_spell_damage;
	}
