...
if eff_type = "play" && skip_target_1 = false {
	var total_damage = 0;
	if opp = true {
		total_damage = -card_state.order_in_stack + global.opponent.ruby_bonus_spell_damage;
		global.opponent.ruby_spell_damage += abs(total_damage);
	} else {
		total_damage = -card_state.order_in_stack + global.player.ruby_bonus_spell_damage;
