...
if (eff_type = "end_turn") && (wait = false) {
	if eff_done = true {
		...
		if global.opp_locale_1 != noone && global.opp_locale_1.position != card_state.position {
			array_push(targets_opp,global.opp_locale_1);
		}
		if global.opp_locale_2 != noone && global.opp_locale_2.position != card_state.position{
			array_push(targets_opp,global.opp_locale_2);
		}
		if global.opp_locale_3 != noone && global.opp_locale_3.position != card_state.position{
			array_push(targets_opp,global.opp_locale_3);
		}
		if global.opp_locale_4 != noone && global.opp_locale_4.position != card_state.position{
			array_push(targets_opp,global.opp_locale_4);
		}
		if global.player_locale_1 != noone && global.player_locale_1.position != card_state.position{
			array_push(targets_player,global.player_locale_1);
		}
		if global.player_locale_2 != noone && global.player_locale_2.position != card_state.position{
			array_push(targets_player,global.player_locale_2);
		}
		if global.player_locale_3 != noone && global.player_locale_3.position != card_state.position{
			array_push(targets_player,global.player_locale_3);
		}
		if global.player_locale_4 != noone && global.player_locale_4.position != card_state.position{
