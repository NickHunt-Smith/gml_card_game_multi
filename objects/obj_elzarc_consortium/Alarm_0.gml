...
if opp = false {
	...
	copy_struct.sequence.tracks[1].keyframes[0].channels[0].spriteIndex = global.rarity_list[rarity_scry_end][element_scry_end][card_type_scry_end][0][card_index_scry_end];
	alarm[1] = 140;
} else {
	array_push(global.opponent.hand_rarity,rarity_scry_end);
	array_push(global.opponent.hand_card_type,card_type_scry_end);
