...
if (eff_type = "play") && (wait = false) {
	if global.resolve_stack = true {
		...
		if eff_done = true {
			...
			reroll_laser = layer_sequence_create("effect_layer",card_state.x+112,card_state.y+184,seq_reroll);
			var target_x = 2136;
			var target_y = 756;
			var source_x = card_state.x+112;
			var source_y = card_state.y+184;
