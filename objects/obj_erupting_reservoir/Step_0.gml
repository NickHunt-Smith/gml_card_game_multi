...
if eff_type = "destroyed" && destroyed_eff_done = false {
	...
	destroyed_locale_x = card_state.x+112; 
	destroyed_locale_y = card_state.y+184; 
	destroyed_locale_position = card_state.position;
	
	array_push(global.destroy_effects,0);
