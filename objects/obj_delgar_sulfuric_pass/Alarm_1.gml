...
if opp = false {
	if global.player_locale_1 != noone {
		if global.player_locale_1.shielded = true {
			...
			seq_change_1 = scr_change_numbers(self_damage,global.player_locale_1.x+global.health_offset_x,global.player_locale_1.y+328);
			global.player_locale_1.health_locale += self_damage;
		}
	}
	if global.player_locale_2 != noone {
		if global.player_locale_2.shielded = true {
			...
			seq_change_2 = scr_change_numbers(self_damage,global.player_locale_2.x+global.health_offset_x,global.player_locale_2.y+328);
			global.player_locale_2.health_locale += self_damage;
		}
	}
	if global.player_locale_3 != noone {
		if global.player_locale_3.shielded = true {
			...
			seq_change_3 = scr_change_numbers(self_damage,global.player_locale_3.x+global.health_offset_x,global.player_locale_3.y+328);
			global.player_locale_3.health_locale += self_damage;
		}
	}
	if global.player_locale_4 != noone {
		if global.player_locale_4.shielded = true {
			...
			seq_change_4 = scr_change_numbers(self_damage,global.player_locale_4.x+global.health_offset_x,global.player_locale_4.y+328);
			global.player_locale_4.health_locale += self_damage;
		}
	}
} else {
	...
	if global.opp_locale_1 != noone {
		if global.opp_locale_1.shielded = true {
			...
			seq_change_5 = scr_change_numbers(self_damage,global.opp_locale_1.x+global.health_offset_x,global.opp_locale_1.y+328);
			global.opp_locale_1.health_locale += self_damage;
		}
	}
	if global.opp_locale_2 != noone {
		if global.opp_locale_2.shielded = true {
			...
			seq_change_6 = scr_change_numbers(self_damage,global.opp_locale_2.x+global.health_offset_x,global.opp_locale_2.y+328);
			global.opp_locale_2.health_locale += self_damage;
		}
	}
	if global.opp_locale_3 != noone {
		if global.opp_locale_3.shielded = true {
			...
			seq_change_7 = scr_change_numbers(self_damage,global.opp_locale_3.x+global.health_offset_x,global.opp_locale_3.y+328);
			global.opp_locale_3.health_locale += self_damage;
		}
	}
	if global.opp_locale_4 != noone {
		if global.opp_locale_4.shielded = true {
			...
			seq_change_8 = scr_change_numbers(self_damage,global.opp_locale_4.x+global.health_offset_x,global.opp_locale_4.y+328);
			global.opp_locale_4.health_locale += self_damage;
		}
	}
}
